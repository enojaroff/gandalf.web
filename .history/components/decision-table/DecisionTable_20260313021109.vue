      ...
      <thead>
        <tr>
          ...
          <th class="dt-cell dt-cell--sep">
            ...
            <UButton icon="i-heroicons-plus" variant="outline" size="sm" @click="showAddFieldModal = true"></UButton>
...
import type { DecisionTable, DecisionVariant, DecisionRule, DecisionField } from '~/types/decision-table'
